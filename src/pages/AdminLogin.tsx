...
const AdminLogin: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const data = await response.json();
      console.log('Response received:', { ...data, token: data.token ? '[REDACTED]' : undefined });
      ...
      setError(err.message || 'Failed to login. Please check if the backend server is running.');
    } finally {
      setLoading(false);
    }
  };
